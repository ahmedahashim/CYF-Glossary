  ...
  if(this.state.term !== null){
      ...
      />
        <h2>Additional Resources</h2>
          <hr className='term-hr'/>
          <SingleResources content={this.state.term.resources} name='resource' placeholder='Resource URL' />
        <h2>Related Terms</h2>
          <hr className='term-hr'/>
<SingleRelated content={this.state.term.related_terms} name='related' placeholder='Related Term' />
          </Fragment>
